/* eslint-disable @typescript-eslint/naming-convention, unicorn/prevent-abbreviations, @typescript-eslint/no-redeclare */
...
export type CheckoutAttributesUpdateInput = {
	...
	/** A list of extra information that is added to the checkout. */
	customAttributes?: InputMaybe<AttributeInput[]>;
...
export type CheckoutCreateInput = {
	...
	email?: InputMaybe<Scalars['String']>;
	/** A list of line item objects, each one containing information about an item in the checkout. */
	lineItems?: InputMaybe<CheckoutLineItemInput[]>;
	/** The text of an optional note that a shop owner can attach to the checkout. */
	note?: InputMaybe<Scalars['String']>;
	/**
...
export type FullVariantFragment = {
	__typename?: 'ProductVariant';
	id: string;
	title: string;
	...
	priceV2: {__typename?: 'MoneyV2'; amount: string; currencyCode: CurrencyCode};
	compareAtPriceV2?:
		| {
				__typename?: 'MoneyV2';
				amount: string;
...
export type FullVariantWithProductFragment = {
	__typename?: 'ProductVariant';
	id: string;
	title: string;
	sku?: string | undefined;
...
export type FullCheckoutFragment = {
	__typename?: 'Checkout';
	id: string;
	webUrl: string;
...
export type FullMetafieldFragment = {
	__typename?: 'Metafield';
	id: string;
...
export type CreateCartMutationVariables = Exact<Record<string, never>>;
...
export type UpdateItemsInCartMutationVariables = Exact<{
	cartID: Scalars['ID'];
	lines: CartLineUpdateInput[] | CartLineUpdateInput;
}>;

export type UpdateItemsInCartMutation = {
	__typename?: 'Mutation';
	cartLinesUpdate?:
		| {
				__typename?: 'CartLinesUpdatePayload';
...
export type UpdateCartNoteMutation = {
	__typename?: 'Mutation';
	cartNoteUpdate?:
		| {
				__typename?: 'CartNoteUpdatePayload';
...
export type UpdateCartDiscountsMutationVariables = Exact<{
	cartID: Scalars['ID'];
	codes?: InputMaybe<Array<Scalars['String']> | Scalars['String']>;
}>;

export type UpdateCartDiscountsMutation = {
	__typename?: 'Mutation';
	...
	customerAccessTokenCreate?:
		| {
				...
				customerUserErrors: Array<{
					__typename?: 'CustomerUserError';
					code?: CustomerErrorCode | undefined;
					field?: string[] | undefined;
					message: string;
				}>;
		  }
...
export type CustomerAccessTokenRenewMutation = {
	__typename?: 'Mutation';
...
export type BlogArticlesByQueryAndIdQueryVariables = Exact<{
	id: Scalars['ID'];
	query: Scalars['String'];
	first: Scalars['Int'];
}>;

export type BlogArticlesByQueryAndIdQuery = {
	__typename?: 'QueryRoot';
	blog?:
		| {
				__typename?: 'Blog';
...
export type BlogArticlesByQueryAndSlugQueryVariables = Exact<{
	slug: Scalars['String'];
	query: Scalars['String'];
	first: Scalars['Int'];
}>;

export type BlogArticlesByQueryAndSlugQuery = {
	__typename?: 'QueryRoot';
	blog?:
		| {
				__typename?: 'Blog';
...
export type BlogArticlesBySlugAndIdQueryVariables = Exact<{
	id: Scalars['ID'];
	slug: Scalars['String'];
}>;

export type BlogArticlesBySlugAndIdQuery = {
	__typename?: 'QueryRoot';
	blog?:
		| {
				__typename?: 'Blog';
...
export type BlogArticlesBySlugsQueryVariables = Exact<{
	slugBlog: Scalars['String'];
	slugArticle: Scalars['String'];
}>;

export type BlogArticlesBySlugsQuery = {
	__typename?: 'QueryRoot';
	blog?:
		| {
				__typename?: 'Blog';
...
export type BlogArticlesSlugByBlogSlugQueryVariables = Exact<{
	slugBlog: Scalars['String'];
}>;

export type BlogArticlesSlugByBlogSlugQuery = {
	__typename?: 'QueryRoot';
	blog?:
		| {
				__typename?: 'Blog';
				articles: {
					...
					edges: Array<{
						__typename?: 'ArticleEdge';
						node: {__typename?: 'Article'; id: string; handle: string};
					}>;
				};
		  }
		| undefined;
...
export type CollectionsHandlesQueryVariables = Exact<{
	first: Scalars['Int'];
}>;

export type CollectionsHandlesQuery = {
	__typename?: 'QueryRoot';
	collections: {
		__typename?: 'CollectionConnection';
		pageInfo: {
...
export type MetafieldByCollectionIdQueryVariables = Exact<{
	id: Scalars['ID'];
	namespace: Scalars['String'];
	key: Scalars['String'];
}>;

export type MetafieldByCollectionIdQuery = {
	__typename?: 'QueryRoot';
	collection?:
		| {
				__typename?: 'Collection';
...
export type MetafieldByProductHandleQueryVariables = Exact<{
	handle: Scalars['String'];
	namespace: Scalars['String'];
	key: Scalars['String'];
}>;

export type MetafieldByProductHandleQuery = {
	__typename?: 'QueryRoot';
	product?:
		| {
				__typename?: 'Product';
...
export type MetafieldByProductIdQuery = {
	__typename?: 'QueryRoot';
	product?:
		| {
				__typename?: 'Product';
...
export type MetafieldByVariantIdQueryVariables = Exact<{
	id: Scalars['ID'];
	namespace: Scalars['String'];
	key: Scalars['String'];
}>;

export type MetafieldByVariantIdQuery = {
	__typename?: 'QueryRoot';
	node?:
		| {__typename: 'AppliedGiftCard'}
		| {__typename: 'Article'}
...
export type VariantMetafieldByProductHandleQueryVariables = Exact<{
	handle: Scalars['String'];
	namespace: Scalars['String'];
	key: Scalars['String'];
}>;

export type VariantMetafieldByProductHandleQuery = {
	__typename?: 'QueryRoot';
	product?:
		| {
				__typename?: 'Product';
...
export type VariantMetafieldByProductIdQueryVariables = Exact<{
	id: Scalars['ID'];
	namespace: Scalars['String'];
	key: Scalars['String'];
}>;

export type VariantMetafieldByProductIdQuery = {
	__typename?: 'QueryRoot';
	product?:
		| {
				__typename?: 'Product';
...
export type ProductImagesByHandleQueryVariables = Exact<{
	handle: Scalars['String'];
}>;

export type ProductImagesByHandleQuery = {
	__typename?: 'QueryRoot';
	product?:
		| {
				__typename?: 'Product';
...
export type ProductImagesByIdQueryVariables = Exact<{
	id: Scalars['ID'];
}>;

export type ProductImagesByIdQuery = {
	__typename?: 'QueryRoot';
	product?:
		| {
				__typename?: 'Product';
...
export type ProductIdByHandleQueryVariables = Exact<{
	handle: Scalars['String'];
}>;

export type ProductIdByHandleQuery = {
	__typename?: 'QueryRoot';
	product?: {__typename?: 'Product'; id: string} | undefined;
};
...
export type ProductsHandlesQueryVariables = Exact<{
	first: Scalars['Int'];
}>;

export type ProductsHandlesQuery = {
	__typename?: 'QueryRoot';
	products: {
		__typename?: 'ProductConnection';
		pageInfo: {
		...
		edges: Array<{
			__typename?: 'ProductEdge';
			cursor: string;
			node: {__typename?: 'Product'; id: string; handle: string};
		}>;
	};
};

export type ProductsHandlesRelatedQueryVariables = Exact<{
	handle: Scalars['String'];
}>;

export type ProductsHandlesRelatedQuery = {
	__typename?: 'QueryRoot';
	product?:
		| {
				__typename?: 'Product';
